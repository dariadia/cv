    ...
    data: {
        language: [
            // russian data
            {
                ...
                skillsPlus: ['git', 'webpack', 'Node.js', 'bootstrap + Vue', 'HTML5 canvas', 'БЭМ'],
            ...
            // english data
            {
                ...
                skillsPlus: ['git', 'webpack', 'Node.js','bootstrap + Vue', 'HTML5 canvas', 'BEM'],
                ...
                portfolioItems: [
                    {name: 'Landing page', desc: 'adaptive WD, Bootstrap, jQuery', src: 'images/portfolio01.png', height: '250', link: './portfolio/website-australia/index.html'},
                    ...
                    {name: 'Landing page', desc: 'adaptive, .scss', src: 'images/portfolio03.png', height: '200', link: './portfolio/coffeeshop/index.html'},
                    {name: 'The snake game', desc: ' js', src: 'images/portfolio04.png', height: '200', link: './portfolio/snake_game/index.html'},
                    {name: 'Landing page', desc: 'parallax', src: 'images/portfolio05.png', height: '200', link: './portfolio/parallax_website/index.html'},
                ],
            }, 
