   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-sm-6">
            <h4>Frontend</h4>
            <div 
               v-for="skill in language[lang].skillsExt" 
               :key="skill.name" 
               class="flex-column">
         ...
         <div class="col-sm-4 spacer-left">
            ...
            <div class="row spacer-left-sm">
                  <ul class="list-icons iron bold-list">
                     <li v-for="skill in language[lang].skillsPlus" 
                        :key="skill" 
                        class="li-glowing">
                        <i class="fas fa-map-pin royal-blue-font"></i> 
                        {{ skill }}
                     </li>
                  </ul>
            </div>   
      ...
      <div class="row">
         <div class="col-sm-6">
            <ul class="list-icons iron bold-list">
               <li class="list-skill" 
                  v-for="skill in language[lang].languagesExt" 
                  :key="skill.name"> 
      ...
      <div class="row">
         <div class="col-sm-6">
            <h4>{{ language[lang].experience }}</h4>
               <ul class="list-icons iron bold-list">
                  <li class="list-skill" 
                     v-for="item in language[lang].experienceExt" 
                     :key="item.time"> 
